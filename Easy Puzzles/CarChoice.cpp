...
// Assuming that both cars cost the same and that the price of fuel remains constant, which car will minimize Chef's expenses? Print your answer as a single integer in the following format. If it is better to choose Car 1, print -1. If both the cars will result in the same expenses, print 0. If it is better to choose Car 2, print 1
...
int main() {
    ...
    while (t--) {
        ...
        else if (x1 / y1 == x2 / y2) cout << "0" << endl;
        else cout << "1" << endl;
    }
}